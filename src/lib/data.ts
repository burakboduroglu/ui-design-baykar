import { Search, Shield, Rocket, TvMinimal, Podcast, SlidersVertical } from 'lucide-react';
...
export const comments = [
  ...
  },
  {
    id: 4,
    content:
      'Magna amet nisi aenean integer nisl scelerisque tristique nunc et. Sed turpis aenean duis id diam metus lectus.',
...
export const items = [
  { icon: Search, text: 'Bibendum tellus', size: 'h-5 w-5' },
  { icon: Shield, text: 'Cras eget', size: 'h-5 w-5' },
  { icon: Rocket, text: 'Dolor pharetra', size: 'h-5 w-5' },
  { icon: TvMinimal, text: 'Amet, fringilla', size: 'h-4 w-4' },
  { icon: Podcast, text: 'Amet nibh', size: 'h-4 w-4' },
  { icon: SlidersVertical, text: 'Sed velit', size: 'h-4 w-4' },
];
